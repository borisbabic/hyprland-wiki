...
{{< tabs items="Generic,NixOS/Home Manager/VS Code" >}}
...
{{< tab "NixOS/Home Manager" >}}

Since NixOS doesn't save the files at `/usr/share/hypr/stubs/` and the location changes with each version, you can use home manager to create the file `.luarc.json` file instead. Change `.config/hypr` to the root of your working directory 
